// The page, page_size and sort "query string parameters" are things
// that you’ll potentially want to use on other endpoints in your API
...
// Additional sanity checks on the query string values provided by the client
